...
for each2 in cate_url_ls:
    ...
    while True:
        ...
        wait.until(
            EC.presence_of_all_elements_located((By.XPATH,'//div[@id="J_goodsList"]/ul/li[@class="gl-item"]//div[@class="p-price"]'))
        )
        # 获取页数
        ...
        for each4 in medicine_url_ls:
            ...
            price = browser.find_elements_by_xpath('//div[@class="summary-price J-summary-price"]//span[@class="p-price"]/span[contains(@class,"price")]')[0].text.strip()
            print('price:',price)
            ...
            print('='*200)
            # 数据存储
            filename = './data/medicine_data_1911.csv'
